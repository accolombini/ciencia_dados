...
# Objective : Como a linguagem Python pode contribuir para os processos de itens frequentes utilizando o algoritmo Eclat
# Created by: accol
# Created on: 09/06/2020

# Atenção -> alterações terão que que ser feitas nos arquivos transacao2.txt para que ele fique adequado ao trabalho => virgulas serão substituidas por espaços ' ' e cada linha deverá especificar o número de itens. O arquivo original transacoes2.txt foi renomeado para transacoes2_normal.txt
...
if	__name__== "__main__":
	main('D:/Users/Angelo/AULAS/Dados/transacoes2.txt', 2);
